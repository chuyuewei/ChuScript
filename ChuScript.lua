if CS_LOADED and not _G.CS_DEBUG then
	-- error("ChuScript is already running!", 0)
	return
end

pcall(function() getgenv().CS_LOADED = true end)
...
CSMouse = cloneref(Players.LocalPlayer:GetMouse())
...
-- xylex & europa
local csassets = {
	["chuscript/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
	["chuscript/assets/close.png"] = "rbxassetid://5054663650",
	["chuscript/assets/editaliases.png"] = "rbxassetid://5147488658",
	["chuscript/assets/editkeybinds.png"] = "rbxassetid://129697930",
	["chuscript/assets/edittheme.png"] = "rbxassetid://4911962991",
	["chuscript/assets/editwaypoints.png"] = "rbxassetid://5147488592",
	["chuscript/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
	["chuscript/assets/logo.png"] = "rbxassetid://1352543873",
	["chuscript/assets/minimize.png"] = "rbxassetid://2406617031",
	["chuscript/assets/pin.png"] = "rbxassetid://6234691350",
	["chuscript/assets/reference.png"] = "rbxassetid://3523243755",
	["chuscript/assets/settings.png"] = "rbxassetid://1204397029"
}
...
local function getcustomasset(asset)
	...
	return csassets[asset]
end

if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		local assets = "https://raw.githubusercontent.com/chuscript/backup/refs/heads/main/"
		for _, folder in {"infiniteyield", "chuscript/assets"} do
			if not isfolder(folder) then
				makefolder(folder)
			end
		end
		for path in csassets do
			if not isfile(path) then
				writefile(path, game:HttpGet((path:gsub("chuscript/", assets))))
			end
		end
		if IsOnMobile then writefile("chuscript/assets/.nomedia", "") end
	end)
end
...
Title.TextSize = 18
Title.Text = "ChuScript FE v" .. currentVersion
...
SettingsButton.Image = getcustomasset("chuscript/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("chuscript/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("chuscript/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("chuscript/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("chuscript/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("chuscript/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("chuscript/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("chuscript/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("chuscript/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("chuscript/assets/pin.png")
...
Logo.Image = getcustomasset("chuscript/assets/logo.png")
...
ExitImage_2.Image = getcustomasset("chuscript/assets/close.png")
...
Img.Image = getcustomasset("chuscript/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("chuscript/assets/close.png")
...
ExitImage_5.Image = getcustomasset("chuscript/assets/close.png")
...
ImageLabel.Image = getcustomasset("chuscript/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("chuscript/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("chuscript/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("chuscript/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
function createPopup(title, text)
	...
	ExitImage.Image = getcustomasset("chuscript/assets/close.png")
	ExitImage.ZIndex = 10
...
CSMouse.KeyDown:Connect(function(Key)
	if (Key==prefix) then
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- ChuScript Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
function selectPart()
	...
	local function HighlightPart()
		if selected.Adornee ~= CSMouse.Target then
			selectionBox.Adornee = CSMouse.Target
		else
			selectionBox.Adornee = nil
		end
	end
	ActivateHighlight = CSMouse.Move:Connect(HighlightPart)
	local function SelectPart()
		if CSMouse.Target ~= nil then
			selected.Adornee = CSMouse.Target
			Path.Text = getHierarchy(CSMouse.Target)
		end
	end
	ClickSelect = CSMouse.Button1Down:Connect(SelectPart)
end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the ChuScript discord server.'}
...
function checkTT()
	local t
	local guisAtPosition = COREGUI:GetGuiObjectsAtPosition(CSMouse.X, CSMouse.Y)
	...
	if t ~= nil and t:GetAttribute("Title") ~= nil then
		...
		local xP
		local yP
		if CSMouse.X > 200 then
			xP = x - 201
		else
			xP = x + 21
		end
		if CSMouse.Y > (CSMouse.ViewSizeY-96) then
			yP = y - 97
		else
			yP = y
		end
			...
			if cmd then
				...
				if infTimes then
					while lastBreakTime < cmdStartTime do
						...
						if not success and _G.CS_DEBUG then
...
local MousePositionToVector2 = function()
	return Vector2.new(CSMouse.X, CSMouse.Y)
end
...
local function clicktpFunc()
	pcall(function()
		...
		local hitPosition = CSMouse.Hit.Position
...
CSMouse.Button1Down:Connect(function()
	for i,v in pairs(binds) do
		...
		elseif v.COMMAND == 'clickdel' then
			...
			if input == 'RightClick' and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
				pcall(function() CSMouse.Target:Destroy() end)
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ChuScript/chuscript/master/source'))()")
	end
end)
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepIY','ChuScript will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepIY','ChuScript will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
addcmd("serverscan", {}, function(args, speaker)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/chuscript/backup/refs/heads/main/serverscanner.lua"))()
end)
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			qUp = CSMouse.KeyUp:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue + 0.5
				end
			end)
			eUp = CSMouse.KeyUp:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue - 1.5
				end
			end)
			qDown = CSMouse.KeyDown:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue - 0.5
				end
			end)
			eDown = CSMouse.KeyDown:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue + 1.5
				end
			end)
...
function deleteGuisAtPos()
	pcall(function()
		local guisAtPosition = PlayerGui:GetGuiObjectsAtPosition(CSMouse.X, CSMouse.Y)
		for _, gui in pairs(guisAtPosition) do
...
addcmd("f3x", {"fex"}, function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/chuscript/backup/refs/heads/main/f3x.lua"))()
end)
...
addcmd('hovername',{},function(args, speaker)
	...
	nbUpdateFunc = CSMouse.Move:Connect(updateNameBox)
end)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function()
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/ChuScript/chuscript/master/version")
		return HttpService:JSONDecode(versionJson)
	end)

	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated", "Get the new version at chuscript.github.io")
		end
